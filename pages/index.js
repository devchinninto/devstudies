  ...
  return (
    ...
    <div style={{
      ...
      <div style={{
        ...
        textAlign: 'center', maxWidth: '300px', boxShadow: '0 4px 15px rgba(0,0,0,0.2)'
      }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: '10px', marginTop: '20px' }}>
          ...
          <button 
            onClick={onFear}
            style={{ padding: '12px', backgroundColor: '#ff6b6b', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '16px' }}
          >
            Vai com medo mesmo! 😱
          </button>
          ...
          <button 
            onClick={onThink}
            style={{ padding: '12px', backgroundColor: '#4ecdc4', color: 'white', border: 'none', borderRadius: '8px', cursor: 'pointer', fontSize: '16px' }}
          >
            Deixa eu pensar... 💭
          </button>
        </div>
...
function Message() {
  return (
    <h1>Muri, confia no processo! Escolha seu caminho abaixo. 😎</h1>
  );
}
  ...
  return (
    <button 
      ...
      style={{ 
        ...
        padding: '10px', margin: '10px', borderRadius: '5px', cursor: 'pointer', border: '1px solid #ccc'
      }}
    >
      {text}
    </button>
    ...
    <div style={{ padding: '20px', fontFamily: 'Arial', textAlign: 'center' }}>
      ...
      {showImg1 && (
        <div style={{ animation: 'fadeIn 1s' }}>
          ...
          <img src={images.img1} alt="Imagem 1" width={250} style={{ borderRadius: '10px' }} />
      ...
      {showImg2 && (
        <div style={{ animation: 'fadeIn 1s' }}>
           ...
           <img src={images.img2} alt="Imagem 2" width={250} style={{ borderRadius: '10px' }} />
